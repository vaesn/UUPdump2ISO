@echo off
:: Generated on 2026-08-14 11:09:24 GMT
...
:START_PROCESS
title 19045.7663_amd64_zh-cn_multi_bad2be40 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=bad2be40-10fb-4c85-9604-108e3131e6f9&pack=zh-cn&edition=professional%%3Bcore&aria2=2"
